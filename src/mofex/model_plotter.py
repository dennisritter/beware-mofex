...
def plot_val_acc_on_batch(val_accuracies, model_name, dataset_name, num_pretrained_epochs=0, path='data', show=False, save=True):
    ...
    plot_name = f'{model_name}_{dataset_name}_e{num_pretrained_epochs}-{num_epochs}'
